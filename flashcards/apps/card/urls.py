...
urlpatterns = [
    ...
    path('information/render/add/<int:word_id>/<int:creator_id>/', views_information.render_add_definition_view, name='render_add_definition'),
    path('information/add/<int:word_id>/<int:creator_id>/', views_information.add_definition_view, name='add_definition'),
    path('information/render/edit_information/<int:word_id>/<int:creator_id>/', views_information.render_edit_information_view, name='render_edit_information'),
    path('information/remove<int:word_id>/<int:creator_id>/<int:definition_id>/', views_information.remove_definition_view, name='remove_definition'),
    path('information/render/edit/<int:word_id>/<int:creator_id>/<int:definition_id>/', views_information.render_edit_definition_view, name='render_edit_definition'),
    path('information/edit/<int:word_id>/<int:creator_id>/<int:definition_id>/', views_information.edit_definition_view, name='edit_definition'),
